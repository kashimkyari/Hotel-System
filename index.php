		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">NEW KEFFI <span>HOTEL</span><p class="logo_w3l_agile_caption">CAPTION GOES HERE</p></a></h1>
				</div>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>NEW KEFFI HOTEL</h4>
									<h3>Let's make memories together</h3>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>NEW KEFFI<span>HOTEL</span></h4>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">NEW KEFFI HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong><a href="tel:+2348030991029">08030991029S</a></p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:reservations@newkeffihotel.com.ng">MAIL US</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Along Keffi - Akwanga Road
Adjacent Ta'al E-library
