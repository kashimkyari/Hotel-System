            ...
            <div id="page-inner">
			 <div class="row">
			   ...
			   ?>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Send The NewsLetter to Subscribers</h3>
						<?php
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==1 )
											{
												echo"<tr class='gradeC'>
													...
													<td>".$row['cdate']."</td>
													<td>".$row['approval']."</td>
													<td><a href=newsletter.php?eid=".$id ." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> Accept</button></td>
													<td><a href=newsletterdel.php?eid=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Decline</button></td>
												</tr>";
											}
											else
											{
