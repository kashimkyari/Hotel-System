...
header span { margin: 0 0 1em 1em; max-height: 5%; max-width: 15%; position: relative; }
...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>NEW KEFFI HOTEL,</p>
				<p>Along Keffi- Akwanga Road<br>Adjacent Ta'al E-library,<br>Keffi,<BR> Nasarawa State.</p>
				<p>08030991029S</p>
			</address>
			<span><img alt="" src="assets/img/kef.jpg"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- CONTACTUS@NEWKEFFIHOTEL.COM.NG <br>Web :- www.newkeffihotel.com.ng <br> Phone :- 08030991029 </p>
			</div>
		</aside>
	</body>
</html>
